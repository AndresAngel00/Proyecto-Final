...
def registros_trainer():
    trainer={}
    trainer["cedula"]=input("Ingrese la cedula del camper")
    ...
    trainer["nombres"]=input("Ingrese el nombre del camper")
    trainer["apellidos"]=input("Ingrese los apellidos del camper")
    trainer["direccion"]=input("Ingrese la direccion del camper")
    trainer["acudiente"]=input("Ingrese el nombre del acudiente del camper")
    trainer["numero de celular"]=input("Ingrese el numero del camper")
